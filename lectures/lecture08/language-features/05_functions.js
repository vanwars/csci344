...
function greeting(name, contextualGreeting) {
    const nameUpper = name.toUpperCase();
    contextualGreeting(nameUpper);
}

const greetMorning = name => console.log(`good morning ${name}`);
const greetAfternoon = name => console.log(`good afternoon ${name}`);


greeting("Sarah", greetMorning);
greeting("Walter", greetAfternoon);